...
static inline int bit_is_set(int reg, int bit){
...
static inline int bit_is_clear(int reg, int bit){
...
/* A guess based on a 1600MHz memory clock */
static __inline__ void udelay(uint64_t usec)
{
...
static inline int gcdr ( int a, int b )
{
  if ( a==0 ) return b;
  return gcdr ( b%a, a );
}
